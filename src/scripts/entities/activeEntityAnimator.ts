  ...
  onAnimationStart = (listener): void => {
    ...
    switch (action) {
      case ActiveEntityAnimationState.State.MELEEATTACK:
        ...
        let equippedWeapon: Item = parentScene.playerTest.inventory.getPlayerEquipment().getEquippedWeapon()?.getItem() ?? new Item(parentScene, 0, "Default Weapon", ItemType.WEAPON, 0, 0, "default-sprite", "default-sprite", StatModule.getNullModifierStats());
